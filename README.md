...
See [`examples/06-opt-in-features.ts`](./examples/06-opt-in-features.ts) for a full runnable demo.
...
| File                                                                            | Description                                                       |
| ------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [`examples/01-basic-aiml1.ts`](./examples/01-basic-aiml1.ts)                     | Basic AIML 1.0 — predicates, srai, topics, random, serialisation |
| [`examples/02-aiml2-features.ts`](./examples/02-aiml2-features.ts)               | AIML 2.0 — wildcards, maps, triples, sraix, learn                |
